...
/**/  define('HTTP_SERVER', 'http://127.0.0.1');
  ...
  define('HTTP_COOKIE_PATH', '/eticaret2/');
  define('HTTPS_COOKIE_PATH', '/eticaret2/');
  define('DIR_WS_HTTP_CATALOG', '/eticaret2/');
  define('DIR_WS_HTTPS_CATALOG', '/eticaret2/');
...
//  define('DIR_FS_CATALOG', 'C:/xampp/htdocs/eticaret/');
