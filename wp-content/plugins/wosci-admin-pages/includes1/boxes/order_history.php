<?php
/*
  $Id: order_history.php.tortoise.removed,v 1.1 2008/12/26 13:10:36 kako Exp $
...
*/
global $customer_id, $languages_id, $product_ids;
  ...
  //    new infoBoxHeading($info_box_contents, false, false);
      ...
      while ($products = tep_db_fetch_array($products_query)) {
        $customer_orders_string .= '  <tr>' .
                                   '    <td class="infoBoxContents"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products['products_id'].'&p=' . $products['products_id']) . '">' . $products['products_name'] . '</a></td>' .
