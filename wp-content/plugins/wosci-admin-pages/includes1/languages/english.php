...
define('ENTRY_CHANGE_PASSWORD', 'Change Password');
define('HEADER_EDIT_MY_ACCOUNT', 'Edit Account');
define('ENTRY_NEWSLETTER2', 'Newsletter Setting');
define('BOX_HEADING_CUST_SERV', 'Customer Service');
define('BOX_HEADING_COMPANY', 'Help Pages');
define('IN_STOCK', 'In Stock');
define('OUT_OF_STOCK', __('Out of Stok'));
define('SKU', __('SKU#'));
define('INC_TAX', __('Inc. Taxes'));
define('EX_TAX', 'Exl. Taxes');
define('QUANTITY', 'Qty:'); 
