<?php
/*
  $Id: ot_subtotal.php.tortoise.removed,v 1.1 2008/12/26 13:10:22 kako Exp $
...
*/
  ...
  class ot_subtotal {
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Alt-Toplamı Göster', 'MODULE_ORDER_TOTAL_SUBTOTAL_STATUS', 'true', 'Alt-Toplam görüntülensin mi?', '6', '1','tep_cfg_select_option(array(\'true\', \'false\'), ', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sıralama Düzeni', 'MODULE_ORDER_TOTAL_SUBTOTAL_SORT_ORDER', '1', 'Görüntüle İçin Sıralama Düzeni.', '6', '2', now())");
    }
