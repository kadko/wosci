...
// The HTML image wrapper function
  function tep_image($src, $alt = '', $width = '', $height = '', $parameters = '', $pid = 0) {
    if ($pid) { $pop = 'onmouseover="doTooltip(event,'.$pid.')" onmouseout="hideTip()"'; }
...
// the image filename as default
    $image = '<img src="phpThumb/phpThumb.php?src=../' . tep_output_string($src) . '" border="0" '.$pop.' alt="' . tep_output_string($alt) . '"';
