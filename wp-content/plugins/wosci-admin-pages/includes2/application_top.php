...
*/
//BOF we include wp admin function and header to classic osc admin into wp interface
...
// Set the local configuration parameters - mainly for developers
  if (file_exists('includes2/local/configure.php')) include('includes2/local/configure.php');
...
//    include('classes/language.php');
    ...
    $language =  'english';//$lng->language['directory'];
    $languages_id = 1;//$lng->language['id'];
  }
    $language =  'english';//$lng->language['directory'];
    $languages_id = 1;//$lng->language['id'];
// redirect to login page if administrator is not yet logged in
  if (tep_session_is_registered('admin')) {//if (!tep_session_is_registered('admin')) {
    $redirect = false;
...
// include the language translations
  ...
  $current_page = basename($PHP_SELF);
  if (file_exists(DIR_WS_LANGUAGES .  'turkish' . '/' . $current_page)) {
    include(DIR_WS_LANGUAGES .  'turkish' . '/' . $current_page);
  }
...
// split-page-results
//  require('classes/split_page_results.php');
