...
define('BOX_HEADING_HEADER_TAGS_SEO', 'Encabezado Etiquetas SEO');
define('BOX_HEADER_TAGS_ADD_A_PAGE', 'Página Control');
define('BOX_HEADER_TAGS_SILO', 'Silo Control');
define('BOX_HEADER_TAGS_FILL_TAGS', 'Rellene Etiquetas');
define('BOX_HEADER_TAGS_TEST', 'Prueba');
/*** End Header Tags SEO ***/
