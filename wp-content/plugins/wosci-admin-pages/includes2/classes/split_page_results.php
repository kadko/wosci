<?php
/*
  $Id: split_page_results.php.tortoise.removed,v 1.1 2008/12/26 13:10:28 kako Exp $
...
*/
  ...
  class splitPageResults {
    ...
    function display_links($query_numrows, $max_rows_per_page, $max_page_links, $current_page_number, $parameters = '', $page_name = 'pageOSI') {
      global $PHP_SELF;
