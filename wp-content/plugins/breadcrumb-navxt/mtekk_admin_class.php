...
abstract class mtekk_admin
{
	...
	function input_text($label, $option, $width = '32', $disable = false, $description = '')
	{
		...
		<tr valign="top">
			...
			<td>
				<input type="text" name="<?php echo $this->unique_prefix . '_options[' . $option;?>]" id="<?php echo $optid;?>" <?php if($disable){echo ' class=""';}?> value="<?php echo htmlentities($this->opt[$option], ENT_COMPAT, 'UTF-8');?>" size="<?php echo $width;?>" /><br />
	...
	function textbox($label, $option, $height = '3', $disable = false, $description = '')
	{
		...
		<textarea rows="<?php echo $height;?>" <?php if($disable){echo ' class="large-text code"';}else{echo 'class="large-text code"';}?> id="<?php echo $optid;?>" name="<?php echo $this->unique_prefix . '_options[' . $option;?>]"><?php echo htmlentities($this->opt[$option], ENT_COMPAT, 'UTF-8');?></textarea><br />
		<?php if($description !== ''){?><span class="setting-description"><?php echo $description;?></span><?php }
	}
	/**
	...
	function tinymce($label, $option, $height = '3', $disable = false, $description = '')
	{
		...
		<tr valign="top">
			...
			<td>
				<textarea rows="<?php echo $height;?>" <?php if($disable){echo ' class="mtekk_mce"';}else{echo 'class="mtekk_mce"';}?> id="<?php echo $optid;?>" name="<?php echo $this->unique_prefix . '_options[' . $option;?>]"><?php echo htmlentities($this->opt[$option], ENT_COMPAT, 'UTF-8');?></textarea><br />
				<?php if($description !== ''){?><span class="setting-description"><?php echo $description;?></span><?php }?>
			</td>
		</tr>
	<?php
	...
	function input_check($label, $option, $instruction, $disable = false, $description = '')
	{
		...
		<tr valign="top">
			...
			<td>	
				<label>
					<input type="checkbox" name="<?php echo $this->unique_prefix . '_options[' . $option;?>]" id="<?php echo $optid;?>" <?php if($disable){echo ' class=""';}?> value="true" <?php checked(true, $this->opt[$option]);?> />
	...
	{?>
		<label>
			<input name="<?php echo $this->unique_prefix . '_options[' . $option;?>]" type="<?php echo $type;?>" <?php if($disable){echo ' class="togx"';}else{echo 'class="togx"';}?> value="<?php echo $value;?>" <?php checked($value, $this->opt[$option]);?> />
			<?php echo $instruction; ?>
		</label><br/>
	<?php
	}
	...
	function input_select($label, $option, $values, $disable = false, $description = '', $titles = false)
	{
		...
		<tr valign="top">
			...
			<td>
				<select name="<?php echo $this->unique_prefix . '_options[' . $option;?>]" id="<?php echo $optid;?>" <?php if($disable){echo ' class=""';}?>>
