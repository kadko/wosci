...
<div class="row">
    <div class="col-xs-6 col-lg-3" style="margin-top:8px;"><?php echo  __( 'Street Address', 'wosci-language' ); ?></div>
...
?>
<div class="row">
    <div class="col-xs-6 col-lg-3" style="margin-top:8px;"><?php echo  __( 'State', 'wosci-language' ); ?></div>
