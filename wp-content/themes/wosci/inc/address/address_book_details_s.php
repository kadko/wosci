...
?>
  <div class="row">
    ...
    <div class="col-xs-6 col-lg-9" id="states_s">
<?php
  ...
  <div class="row">
    ...
    <div class="col-xs-6 col-lg-9">
     ...
     <?php
		...
		echo tep_get_country_list('country', STORE_COUNTRY, 'class="form-control" onchange="loadXMLDocNew(this.value'.$zonecode.');" '); 
		} else {
		echo tep_get_country_list('country', $entry ['entry_country_id'], 'class="form-control" onchange="loadXMLDocNew(this.value'.$zonecode.');" '); 
		}
		} else {
		echo tep_get_country_list('country', $HTTP_POST_VARS['country'], 'class="form-control" onchange="loadXMLDocNew(this.value'.$zonecode.');" ');
		}
