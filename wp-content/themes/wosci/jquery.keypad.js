...
function Keypad() {
	...
	this.regional[''] = { // Default regional settings
		...
		buttonStatus: 'Tuş Takımını Aç', // Status text for trigger button
		closeText: 'X', // Display text for close link
		closeStatus: 'Tuş Takımını Kapat', // Status text for close link
		clearText: 'Temizle', // Display text for clear link
		clearStatus: 'Tüm Yazılanı Sil', // Status text for clear link
		backText: 'Geri', // Display text for back link
		backStatus: 'Bir Önceki Yazılan Harfi Sil', // Status text for back link
		spacebarText: '&nbsp;', // Display text for space bar
		spacebarStatus: 'Boşluk', // Status text for space bar
